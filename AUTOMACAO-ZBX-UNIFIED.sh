...
# ------------------------------------------------------------------------------
#   • [GERAL] vale para todos os modos: Database, Server e Proxy.
...
#           /root/zabbix_install_error.json, com linha, comando, componente e log.
#         [GERAL] Certificado, JSON e Doctor passaram a exibir uma legenda
#           "ONDE CONFERIR DEPOIS", indicando exatamente qual arquivo abrir para
#           erro, resumo limpo, resumo JSON e diagnóstico.
#         [GERAL] Exports plain passam por sanitização de ANSI, CR e caracteres
#           de controle, permitindo cat seguro do summary_plain.
#         [DOCTOR] Diagnóstico endurecido com timeouts e sem FATAL por grep sem
#           resultado; falhas viram WARN.
#         [DB] timescaledb-tune não aborta mais a instalação; aplica fallback
#           shared_preload_libraries='timescaledb' e registra status.
#         [SERVER] Certificado final volta a exibir DBUser e DBPassword completos,
#           também no JSON estruturado.
# ------------------------------------------------------------------------------
#   v5.3 — 2026-04-27
